...
export function WorkspacePreview({
  ...
  return (
    <section className="hidden border-r border-border/70 p-10 lg:flex lg:flex-col">
      ...
      <div className="mt-10 grid flex-1 gap-6 xl:grid-cols-[minmax(0,1.02fr)_minmax(18rem,0.98fr)]">
        <div className="flex flex-col justify-between gap-8">
          <div>
            ...
            <h1 className="mt-6 font-display text-6xl leading-[0.95] text-text-primary">
              {title}
            </h1>
          ...
          <div className="rounded-[14px] border border-border/70 bg-bg-surface/65 p-5">
            ...
            <div className="mt-4 space-y-3">
              {protocolSteps.map((step, index) => (
                <div
                  key={step}
                  className="flex items-start gap-3 rounded-[10px] border border-border/70 bg-bg-elevated/60 px-4 py-3"
                >
        ...
        <div className="space-y-4">
          <div className="rounded-[14px] border border-border/70 bg-bg-elevated p-5 shadow-lg">
            ...
            <div className="mt-5 space-y-3">
              {lanes.map((lane) => (
                <div
                  key={lane.label}
                  className="rounded-[10px] border border-border/70 bg-bg-elevated/60 px-4 py-3"
                >
                  <div className="flex items-center justify-between gap-3">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="rounded-[10px] border border-border/70 bg-bg-surface/65 px-4 py-4"
              >
