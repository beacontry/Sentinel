 ...
 * Tickers that have been delisted or changed will fail data fetch gracefully
 * and be skipped during optimization.
 */
export const SP500_SYMBOLS: string[] = [
  ...
  "HAL", "HAS", "HBAN", "HCA", "HD", "PEAK", "HES", "HIG", "HII", "HLT",
  ...
  "UDR", "UHS", "ULTA", "UNH", "UNP", "UPS", "URI", "USB", "USFR",
