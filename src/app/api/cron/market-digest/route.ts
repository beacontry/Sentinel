...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // .authorId is notNull). Body is prefixed with a "Sentinel Daily
    ...
    try {
      ...
      if (firstAdmin?.id) {
        ...
        const body =
          `**Sentinel Daily Desk · ${titleDate}**\n\n` +
          result.summary +
          `\n\n---\n\n_Generated by Sentinel's market intelligence pipeline. Not investment advice. ` +
